...
const hoverImages = document.querySelectorAll('.image-container');

hoverImages.forEach(imageDiv => {
    const images = imageDiv.querySelectorAll('.food-image, .hover-image');
...
const galleryImages = document.querySelectorAll('.carousel .gallery-image');
let currentIndex = 0;
